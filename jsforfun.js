window.onload = function() {
    var answers = [
        ...
        'You should not let javascript make up your mind for you.',
        'I hope so, but I doubt it.',
        'I hope not.',
        'Never!',
        'If you follow the path of truthiness, you will achieve your goal.',
        ...
        'Trump was a mistake.',
        'The darkest time is the hour before dawn',
        'Now you are just being silly.',
        'The universe is infinite. And contracting.',
